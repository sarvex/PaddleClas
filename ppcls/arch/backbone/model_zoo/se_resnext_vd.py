...
class SELayer(nn.Layer):
    ...
    def forward(self, input):
        ...
        return paddle.multiply(input, excitation)
...
class ResNeXt(nn.Layer):
    def __init__(self, layers=50, class_dim=1000, cardinality=32):
        ...
        self.block_list = []
        n = 1 if layers in [50, 101] else 3
